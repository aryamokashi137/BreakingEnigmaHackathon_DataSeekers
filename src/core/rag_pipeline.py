...
class RAGPipeline:
    ...
    def web_search(self, state):
        ...
        if not self.web_search_tool:
            logger.info("---WEB SEARCH DISABLED: TAVILY_API_KEY NOT CONFIGURED---")
        ...
        jurisdiction_code = getattr(self.database_manager.case, "jurisdiction_code", "")
        jurisdiction_name = jurisdiction_data.get(jurisdiction_code, "Unknown jurisdiction")
